...
#define MESH     6
#define GEODESIC 7
#define CONE     8 //note: I had to add CONE in.

struct shape3D{
	int type; /*see above for values */
	GLfloat vertices[51][51][4];
	GLfloat normals[51][51][4];
};

struct shape3D sphere;
struct shape3D cone;
struct shape3D cylinder;
struct shape3D torus;
